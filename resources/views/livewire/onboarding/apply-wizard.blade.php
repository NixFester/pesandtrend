<div class="container-app py-8 max-w-2xl mx-auto">
    ...
    <div class="rounded-2xl border border-forest-100 p-6 card-shadow">
        ...
        {{-- Step 4: Dokumen --}}
        @if($step === 4)
        <h2 class="text-lg font-extrabold text-ink mb-4">Upload Dokumen</h2>
        <p class="text-sm text-ink-soft mb-4">Upload dokumen pendukung (opsional, bisa dilengkapi nanti).</p>
        <div>
            <label class="text-sm font-semibold text-ink">Catatan</label>
            <textarea wire:model="notes" class="input-field mt-1" rows="3" placeholder="Catatan tambahan untuk pihak sekolah..."></textarea>
        </div>
        @endif
        ...
        <div class="flex items-center justify-between mt-6 pt-4 border-t border-forest-100">
            ...
            @else
            <button wire:click="submit" type="button" class="btn-gold">
