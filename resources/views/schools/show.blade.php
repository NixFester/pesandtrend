...
@section('content')
            ...
            <div class="mt-5 flex flex-wrap items-start justify-between gap-6">
                ...
                <div class="card-shadow-lg w-full max-w-xs rounded-2xl bg-white p-6">
                    ...
                    <div class="mt-4 space-y-2">
                        ...
                        <a href="{{ $school->whatsapp_href }}" target="_blank" rel="noopener" class="flex w-full items-center justify-center gap-2 rounded-2xl bg-[#25D366] px-4 py-3 text-sm font-bold text-white transition hover:bg-[#1ebe57]">
    ...
    <section class="bg-forest-50 py-10" id="lokasi">
        <div class="container-app">
            <h2 class="text-lg font-extrabold text-ink mb-4">
                <x-icon name="map-pin" class="inline h-5 w-5 text-forest-600"/> Lokasi Sekolah
            </h2>
            <div id="school-detail-map" class="h-64 sm:h-80 rounded-2xl overflow-hidden card-shadow"></div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const map = L.map('school-detail-map').setView([lat, lng], 15);
