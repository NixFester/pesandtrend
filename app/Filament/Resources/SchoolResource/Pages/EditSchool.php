...
class EditSchool extends EditRecord
{
    ...
    protected function getHeaderActions(): array
    {
        ...
        // Add "Fill Sample Data" button in dev mode
        if ($this->isDevMode()) {
            $actions[] = Actions\Action::make('fillSampleData')
                ->label('Isi Data Sample')
                ...
                ->modalHeading('Isi dengan Data Sample?')
                ->modalDescription('Ini akan mengganti semua field dengan data sample. Data tidak akan disimpan sampai Anda klik "Simpan".');
        }
    ...
    protected function getSampleData(): array
    {
        ...
        return [
            ...
            'slug' => Str::slug("Pesantren Sample {$timestamp}"),
